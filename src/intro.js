  ...
  self.render = function () {
    return (
      <div className="taskInstructions">
        ...
        <img src="" alt="outil de substitution : obtenir des indices" />
        ...
        <img src="" alt="outil de recherche : couleurs et symboles" />
        ...
        <img src="" alt="outil de recherche : paires de symboles et paires de lettres" />
        ...
        <img src="" alt="outil d'analyse : symboles" />
        ...
        <img src="" alt="outil d'analyse : paires de symboles" />
